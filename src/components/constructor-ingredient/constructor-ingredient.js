...
function ConstructorIngredient({ item, index, handleDeleteIngredient, swapItems }) {
  ...
  return (
    <li key={index} className={`${constructorIngredient.listItem} mb-4 mr-4`} ref={ref} style={{ opacity: isDragging ? 0 : 1 }}>
      <div className='mr-2'>
